...
<%
	...
	MemberBean member = manager.getMember(user_id);
...
<body>
    ...
    $(function(){
        ...
        IMP.init('imp81231232'); // 'iamport' 대신 부여받은 "가맹점 식별코드"를 사용
        var msg;
        ...
        IMP.request_pay({
            ...
            if ( rsp.success ) {
                ...
                //성공시 이동할 페이지
                location.href='../product/paySuccess.jsp?msg='+msg;
            } else {
                msg = '결제에 실패하였습니다.';
                msg += '에러내용 : ' + rsp.error_msg;
                //실패시 이동할 페이지
                location.href="../product/payFail.jsp";
                alert(msg);
            }
        });
